...
- (void)setRequestRedirectedBlock:(id)arg1;
- (void)setProxyAuthenticationNeededBlock:(id)arg1;
- (void)setAuthenticationNeededBlock:(id)arg1;
- (void)setDataReceivedBlock:(id)arg1;
- (void)setUploadSizeIncrementedBlock:(id)arg1;
- (void)setDownloadSizeIncrementedBlock:(id)arg1;
- (void)setBytesSentBlock:(id)arg1;
- (void)setBytesReceivedBlock:(id)arg1;
- (void)setFailedBlock:(id)arg1;
- (void)setCompletionBlock:(id)arg1;
- (void)setHeadersReceivedBlock:(id)arg1;
- (void)setStartedBlock:(id)arg1;

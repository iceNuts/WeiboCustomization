...
- (id)stringByReplacingOccurrencesOfRegex:(id)arg1 options:(unsigned int)arg2 inRange:(struct _NSRange)arg3 error:(id *)arg4 enumerationOptions:(unsigned int)arg5 usingBlock:(id)arg6;
- (id)stringByReplacingOccurrencesOfRegex:(id)arg1 usingBlock:(id)arg2;
- (BOOL)enumerateStringsSeparatedByRegex:(id)arg1 options:(unsigned int)arg2 inRange:(struct _NSRange)arg3 error:(id *)arg4 enumerationOptions:(unsigned int)arg5 usingBlock:(id)arg6;
- (BOOL)enumerateStringsSeparatedByRegex:(id)arg1 usingBlock:(id)arg2;
- (BOOL)enumerateStringsMatchedByRegex:(id)arg1 options:(unsigned int)arg2 inRange:(struct _NSRange)arg3 error:(id *)arg4 enumerationOptions:(unsigned int)arg5 usingBlock:(id)arg6;
- (BOOL)enumerateStringsMatchedByRegex:(id)arg1 usingBlock:(id)arg2;

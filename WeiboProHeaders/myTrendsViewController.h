...
@class MGTwitterEngine, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, NewHomelineViewController, TableRefreshHeaderView, UIActivityIndicatorView, UITableView, UITableViewCell;

@interface myTrendsViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, TimeLineTab>
{

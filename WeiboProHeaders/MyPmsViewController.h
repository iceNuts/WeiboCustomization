...
@class DetailContainerViewController, MGTwitterEngine, NSMutableArray, TableRefreshHeaderView, UIActivityIndicatorView, UITableView;

@interface MyPmsViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, TimeLineTab>
{

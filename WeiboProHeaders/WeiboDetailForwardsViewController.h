...
@class ImageLoader, MGTwitterEngine_WeiboV4, NSDictionary, NSMutableArray, NewWeiBoDetailThirdViewController, UIActionSheet, UIActivityIndicatorView, UITableView;

@interface WeiboDetailForwardsViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, UIActionSheetDelegate>
{

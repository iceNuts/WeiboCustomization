...
@class MGTwitterEngine_WeiboV4, NSMutableArray, NSString, NSTimer, UIActivityIndicatorView, UITableView;

@interface UserFollowerViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, TimeLineTab, UIScrollViewDelegate, UserInfoDelegate>
{
...
- (void)loadMoreFollowersInfo;
- (void)loadFollowersInfo:(id)arg1;
- (void)loadTimeOut;
- (void)releaseTimer;
- (void)viewDidLoad;
